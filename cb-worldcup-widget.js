    ...
    section.innerHTML = `
      <style>
        #cb-worldcup-widget {
          ...
          box-shadow: inset 0 0 0 1px rgba(75,140,255,.18);
          position: relative;
          overflow: hidden;
        ...
        .cbwc-next {
          ...
          height: 34px;
          border-radius: 50%;
          border: 1px solid rgba(80,150,255,.75);
        ...
        matches && matches.length
          ? `
            <div class="cbwc-scroll-wrap">
              ...
              <button class="cbwc-next" type="button" aria-label="Geser pertandingan">›</button>
            </div>
          `
